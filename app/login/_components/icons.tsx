...
/**
 * Inline SVG icons for the login screen (code-rules.md rule 2a) — inlined so
 * CSS can reach into them, rather than locked-color `<img>` references.
 * Multi-color icons (flag, Google "G") keep their original palette; the
 * mono chevron uses `currentColor` so it inherits the header's text color.
 */

// mm:I662:14391;186:1696;186:1821;186:1709
export function IconFlagVn(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="24"
      height="24"
      ...
      {...props}
    >
      <g clipPath="url(#login-flag-vn-clip)">
      ...
      <defs>
        <clipPath id="login-flag-vn-clip">
