...
| **A1** | `KudosLiveBoardPage#Page` (planned) | `GET` `/kudos` | FR-101, FR-201, FR-202, FR-203, FR-204, FR-205, FR-206, FR-207, FR-208, FR-209, FR-210, FR-211, FR-212, FR-213, FR-214, FR-215, FR-216, FR-217, FR-218, FR-219, FR-402, FR-403, BR-001, BR-003, BR-004, DEC-001, DEC-002, US001, US002, US003, US005, US006, US007, US008 | — *(read-only)* | § 3.1 |
...
`FR-101` `FR-201` `FR-202` `FR-203` `FR-204` `FR-205` `FR-206` `FR-207` `FR-208` `FR-209` `FR-210` `FR-211` `FR-212` `FR-213` `FR-214` `FR-215` `FR-216` `FR-217` `FR-218` `FR-219` `FR-402` `FR-403` · `US001` `US002` `US003` `US005` `US006` `US007` `US008`
...
| **DEC-002** | interaction | chọn hashtag/phòng ban (AND-combine); chọn lại option đang chọn | Cả Highlight và All Kudos lọc lại đồng thời; dropdown đóng ngay khi chọn (FR-210, FR-216); chọn lại để bỏ lọc | TBD |
