...
# SCR002_Homepage — Screen Spec

**Screen**: SCR002_Homepage: Homepage SAA 2025
...
| E10 | Account menu — Admin Dashboard | link | — | — | Conditional (E07 đang mở AND role admin) | Điều hướng `/admin` (placeholder — route riêng, không phải `/profile`) | computed (role) | raw | ẩn hoàn toàn khi không phải admin | N/A |
