...
| Coming Soon (placeholder) | Shell dùng chung cho 4 route chưa có nội dung thật (`/kudos`, `/standards`, `/profile`, `/admin`) — có header/footer thật, chỉ phần thân là thông báo "sắp ra mắt". `/awards-information` từng dùng shell này, nay đã có màn hình thật (F003). | `app/_components/coming-soon.tsx` |
