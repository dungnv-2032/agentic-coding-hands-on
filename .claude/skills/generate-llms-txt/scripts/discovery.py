...
SECTION_ORDER/SECTION_MAP export: consumed by content_contract.py's --audience dev path (phase 2).
"""
import json
import re
...
__all__ = ["CANONICAL_DIRS", "MD_EXT", "EXCLUDE_DIRS", "SECTION_ORDER", "SECTION_MAP", "within",
           "docs_root", "actual_lang", "safe_read", "section_for", "collect_markdown",
           "openapi_specs", "openapi_entries", "resolve_tier", "product_name"]
