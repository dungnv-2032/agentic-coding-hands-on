...
description: >
  ...
  story, pm-create-stories, STORY (PM menu).
...
The skill that elaborates a WBS story from schedule.md to a level usable for design and task creation. Invoked from the `STORY` menu of the `project-manager` agent.
