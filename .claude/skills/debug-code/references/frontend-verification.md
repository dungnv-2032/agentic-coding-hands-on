...
**Missing** → go to Step 2B (automate-browser fallback)
...
## Step 2B: Chrome MCP NOT Available — Fallback to automate-browser Skill
...
> "Visual verification skipped — no Chrome MCP or automate-browser available."
...
```
## Frontend Verification
- Method: [Chrome MCP | automate-browser | skipped]
