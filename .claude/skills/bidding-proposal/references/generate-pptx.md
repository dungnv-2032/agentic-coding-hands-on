...
- `--template "SVN Proposal Menu.pptx"` — name auto-resolves under `bidding-proposal/templates/`
...
| Template not found | Verify `SVN Proposal Menu.pptx` exists under `claude/skills/bidding-proposal/templates/` |
