...
from _structural_fixer_fr_lib import atomic_write_text, fix_spec  # noqa: E402
...
def main(argv: list[str]) -> int:
    ...
    for spec_path in spec_paths:
        ...
        try:
            count = fix_spec(spec_path, backup_root)
    ...
    if not args.no_decrement and total_fixed > 0:
        if review_report.is_file():
            try:
                mutate_review_report(review_report, total_fixed, atomic_write_text)
