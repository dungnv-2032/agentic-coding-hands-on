...
READING_ORDER = [
    ...
    {"layer": 3, "entries": [
        ...
        # v27.0.0 Phase 03: system/business-rules.md is retired (folded into
        # behavior-logic.md) — its reading-order row is removed here, sole owner of
        # this file's business-rules.md rows. Remaining layer-3/4 nums renumbered down.
        {"num": 13, "path": "generated/permissions-matrix.md", "key": "permissions_matrix"},
    ]},
    {"layer": 4, "entries": [
        {"num": 14, "glob": "flows/*.md", "link": "flows/", "key": "flows", "conditional": True},
        {"num": 15, "glob": "features/*/", "link": "features/", "key": "features",
         "conditional": True, "feature_note": True},
        {"num": 16, "glob": "screens/*/spec.md", "link": "screens/", "key": "screens",
         "conditional": True},
        {"num": 17, "path": "generated/traceability-matrix.md", "key": "traceability_matrix",
         "conditional": True},
    ]},
]
...
ROLES = [
    {"key": "new_dev", "path": [1, 2, 4, 5, 7, 15]},
    {"key": "reviewer", "path": [2, 13, 11]},
    {"key": "pm", "path": [1, 5, 6]},
]
