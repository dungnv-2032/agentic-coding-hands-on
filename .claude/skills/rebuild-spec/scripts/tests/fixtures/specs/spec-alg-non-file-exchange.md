...
|------|------|--------------------------|------------------|--------|
| FR-001 | Imports users from a CSV upload | `LoginController` bulk import | | `claude/skills/rebuild-spec/scripts/tests/fixtures/cited-source.py:5-10` |
...
### Compute the account lockout window (ALG-001)
**Linked FR:** FR-001
**Input:** failed login attempt count and last-attempt timestamp
**Output:** lockout expiry timestamp
**Source:** `claude/skills/rebuild-spec/scripts/tests/fixtures/cited-source.py:5-10`

This is important business logic for computing the account lockout window after repeated
