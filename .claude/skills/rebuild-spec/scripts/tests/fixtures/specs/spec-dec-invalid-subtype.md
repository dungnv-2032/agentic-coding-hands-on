...
**subtype:** render, invalid_type
<!-- "invalid_type" is not in {render, interaction, flow} — triggers FeatureSpec.dec_blocks_well_formed critical -->
...
**Source:** app/Http/Controllers/LoginController.php:45-55
