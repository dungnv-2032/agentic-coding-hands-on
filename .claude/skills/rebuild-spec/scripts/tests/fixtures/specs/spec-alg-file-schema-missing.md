...
### Import users from a CSV upload (ALG-001)
**Linked FR:** FR-001
**Input:** CSV file upload of user records
**Output:** count of imported users
**Source:** `claude/skills/rebuild-spec/scripts/tests/fixtures/cited-source.py:5-10`

Parses the uploaded CSV and bulk-imports each row as a user record.
