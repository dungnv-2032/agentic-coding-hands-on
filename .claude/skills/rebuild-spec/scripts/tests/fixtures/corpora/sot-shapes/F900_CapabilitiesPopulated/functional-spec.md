...
| CAP-02 | Register a new account | Fill in the sign-up form, with an invite code where the marketplace requires one | US020 | FR-004, FR-005 | BR-002, BR-003, BR-004, BR-006, DEC-002, SM-001 | SCR021 |
...
```mermaid
journey
    title F900_CapabilitiesPopulated user journey
