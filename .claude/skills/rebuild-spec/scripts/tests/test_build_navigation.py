...
class TestIndexPruning:
    ...
    def test_all_present_no_footnote(self, tmp_path):
        ...
        # v27.11.0 W6: the traceability-matrix conditional entry (now 17, after the two
        # retired-pass rows went) — must be present too, or the footnote fires.
        (docs / "generated" / "traceability-matrix.md").write_text("# traceability-matrix\n")
        content = _build_index_readme(str(docs), "en", "2026-01-01T00:00:00Z")
...
class TestIndexRichContent:
    ...
    def test_role_drops_absent_number(self, tmp_path):
        # reviewer path is [2, 13, 11] (architecture, permissions_matrix, api_contracts);
        # drop api-contracts (#11) → 11 gone
        docs = _make_layered_docs_tree(tmp_path, with_api_contracts=False)
        content = _build_index_readme(str(docs), "en", "2026-01-01T00:00:00Z")
        ...
        assert "13" in line and "2" in line
...
class TestReadingOrderConsistency:
    ...
    def test_numbers_are_contiguous_1_to_17(self):
        # v27.0.0 Phase 03: system/business-rules.md's row removed (folded into
        # behavior-logic.md) — one fewer entry, contiguous 1..18 (was 1..19).
        # v27.11.0 W6: generated/traceability-matrix.md APPENDED as 19 — contiguous 1..19.
        # Two retired-pass rows (17, 18) removed and traceability-matrix renumbered
        # 19 -> 17. Renumbering the TAIL row is safe here — nothing pins 19, and the
        # layer-1..3 numbers other tests pin (11, 13, 14, 15) sit below the removed pair.
