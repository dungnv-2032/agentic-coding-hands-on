...
//   <primary_docs_root>/system/*.md         (glob-based — any new system artifact is picked up
//                                            without a registry change, F2)
...
//                                          rides the SAME glob as the mandatory 2 files
//                                          (technical-spec.md/functional-spec.md, v27.0.0
//                                          audience split); no registry change needed, F2)
