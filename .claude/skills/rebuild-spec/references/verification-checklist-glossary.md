...
**Cross-refs:** `docs/generated/entities.md` (entity names, field names), `docs/features/*/functional-spec.md` (term usage)
...
- [ ] **GL-R4 Term sourcing:** each term must appear in >=1 of: `docs/generated/entities.md` OR >=2 `docs/features/*/functional-spec.md` files. A term present in only 1 functional-spec with no entity counterpart → warning (candidate for removal or consolidation).
