...
|------|------|---------|---------|--------------|
| {BL001_CODE} | {BL001_NAME} | {TRIGGER} | {channel/topic + data fields — omit for non-event/non-notification types} | {`\| Column \| Type \| Required \| Notes \|` summary, or `N/A — not a file-exchange type`} |

### Type: {TYPE_B}

| Code | Name | Trigger | Payload | File Schema |
|------|------|---------|---------|--------------|
| {BL002_CODE} | {BL002_NAME} | {TRIGGER} | {channel/topic + data fields — omit for non-event/non-notification types} | {`\| Column \| Type \| Required \| Notes \|` summary, or `N/A — not a file-exchange type`} |
| {BL003_CODE} | {BL003_NAME} | {TRIGGER} | {channel/topic + data fields — omit for non-event/non-notification types} | {`\| Column \| Type \| Required \| Notes \|` summary, or `N/A — not a file-exchange type`} |
