...
- Fetch with `gh issue list --state open` against the repository under `## GitHub Settings` in `pm-memory.md`. If unauthenticated or unconfigured, **skip this section** and continue with the other inputs.
