...
> `screen-list.md` — are not yet in canonical-mapping; those paths are carried here until that file
> lists them. `behavior-logic.md` is now tracked in canonical-mapping as of v27.0.0.)
>
...
| **Feature detail / wireframe** | "detail/spec for feature X", "how does X work", "wireframe for X" | `docs/features/{slug}/functional-spec.md` (v27.0.0 — BA/QA: overview, screens, user stories, scenarios), `docs/generated/screen-list.md` | `docs/features/{slug}/technical-spec.md` (dev detail — endpoints, pseudocode, Source citations), `plans/<active>/artifacts/screens/SCR###*/spec.md` | spec walkthrough (+ wireframe description) | Systems Designer |
