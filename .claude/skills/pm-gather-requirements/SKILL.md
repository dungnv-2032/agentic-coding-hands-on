...
description: >
  ...
  non-functional requirements, role list, glossary, service overview, pm-gather-requirements, REQ (PM menu).
...
Creates the documents for the requirements definition phase. Invoked from the `REQ` menu of `project-manager`.
