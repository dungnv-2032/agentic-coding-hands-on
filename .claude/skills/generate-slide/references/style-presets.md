...
**Two categories, don't confuse them.** Presets 1-12 below are **Inspired** — a starting palette/type
pairing to riff on, adjust freely to fit the content. Preset 13 (**Official Brand**) is different in
kind: it's the real Sun* v4 design system, brand-locked — colors, fonts, and the 23-component markup
are fixed, not a suggestion. See `references/sun-official-components.md` for its full catalog.
...
**Vibe:** Official Sun* corporate — confident, precise, red-accent-disciplined ("red appears once per
slide"). Not "inspired by" — this IS the brand.

**Layout:** 23 dedicated slide-type layouts (cover, agenda, section divider, one/two-column, data/KPI/
stats, table, quote, team, roadmap, process flow, swimlane workflow, system diagram, 5 image layouts,
feature full-bleed, brand guide, thank you) — a picker menu, not a fixed deck shape.

**Typography:**
- Display/Body: `Be Vietnam Pro` (400/500/600/700)
- Editorial variant display: `Space Grotesk` (500/700)
...
**Signature Elements:**
- 8-point asterisk mark + red kicker label on every slide
- Two visual variants: `crisp` (white bg, default) and `editorial` (warm cream bg + Space Grotesk +
  brand slides invert to solid red)
- 4 feature toggles: footer logo, page number, decorative background art, entrance animation
- Full component catalog (23 slide layouts, 2 variants, toggle contract, responsive `clamp()` mapping):
  see `sun-official-components.md`.
...
| Sun* Official (#13, Official Brand) | Be Vietnam Pro | Be Vietnam Pro (Space Grotesk in Editorial) | Google |
