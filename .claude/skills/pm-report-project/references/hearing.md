...
> Should I check the actual progress, completion status and blockers of the individual tasks with the EM (delivery-tracker) and pull that in? (Tell me the target WBS/period and I'll delegate and consolidate it.)
