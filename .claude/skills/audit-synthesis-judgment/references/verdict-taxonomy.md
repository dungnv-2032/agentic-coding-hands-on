...
| `CAP_MULTI_INTENT` | WARN | 3 | a single § 2 CAP row (`>= 3` claimed US) bundles user stories that do NOT share one primary business outcome (phase 10) |
...
| **low** | cosmetic naming, a granularity outlier with no security/data impact |
