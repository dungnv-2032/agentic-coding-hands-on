...
The subjective "one artifact re-states another with no added why" case is a reviewer judgment and
is out of scope for this skill [Red-team F8 / user Q2]. This lib decides ONLY the unambiguous
...
citation (mandated ADR quotes are required by contract, not a re-statement) [Red-team FM-F4].
This lib does not do span-similarity at all — it matches whole-artifact identity — so that trap
is avoided by construction. Trivially-small / template-stub files are exempt (a shared empty
