...
description: |
  ...
  assistant: "Passing this to the delivery-tracker agent, which will read the phase files against the code in takumi-cli and report what is genuinely delivered versus merely marked done."
  <commentary>
  ...
  assistant: "Let me spawn the delivery-tracker agent to read the status, priority, branch, and blockedBy fields across the plan index files and produce a report under plans/reports/."
  <commentary>
