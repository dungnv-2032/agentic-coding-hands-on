...
/**
 * Vietnamese homepage copy, transcribed verbatim from
 * `plans/260905-1153-homepage-saa/design/homepage-saa.png`. Do not
 * paraphrase or "improve" the prose — it is design copy, not documentation.
 *
 * The one deliberate departure from the frame: "Coming soon" is spelled
 * correctly here even though the frame reads "Comming soon" (a design typo;
 * see clarifications.md ORCH-08 and FR-202).
 */
export const viHome: Dictionary["home"] = {
  ...
  eventLivestream: "Tường thuật trực tiếp qua sóng Livestream",
  ...
  rootFurther: {
    ...
    paragraphs: [
      ...
      `Vượt ra khỏi nét nghĩa bề mặt, "Root Further" chính là hành trình chúng ta không ngừng vươn xa hơn, cắm rễ mạnh hơn, chạm đến những tầng "địa chất" ẩn sâu để tiếp tục tồn tại, vươn lên và nuôi dưỡng đam mê kiến tạo giá trị luôn cháy bỏng của người Sun*. Mượn hình ảnh bộ rễ liên tục đâm sâu vào lòng đất, mạnh mẽ len lỏi qua từng lớp "trầm tích" để thẩm thấu những gì tinh túy nhất, người Sun* cũng đang "hấp thụ" dưỡng chất từ thời đại và những thử thách của thị trường để làm mới mình mỗi ngày, mở rộng năng lực và mạnh mẽ "bén rễ" vào kỷ nguyên AI - một tầng "địa chất" hoàn toàn mới, phức tạp và khó đoán, nhưng cũng hội tụ vô vàn tiềm năng cùng cơ hội.`,
    ...
    quoteSource: "(Cây sâu bén rễ, bão giông chẳng nề - Ngạn ngữ Anh)",
  },
  awards: {
